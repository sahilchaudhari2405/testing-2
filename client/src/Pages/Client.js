...
//         dispatch(fetchClientOrders()); // Fetch the updated data
//       } catch (error) {
...
//             <button onClick={() => exportToExcel(orders)} className="bg-white text-black border-black border-[1px] px-4 py-2 rounded hover:text-red-600">
//               Export clients
//             </button>
