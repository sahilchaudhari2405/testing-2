...
const Chartofdonut = ({dateWiseCustomers, weekWiseCustomers, monthWiseCustomers }) => {
    const [timeFrame, setTimeFrame] = useState('day');
    const [chartData, setChartData] = useState([]);
    const [monthWiseCustomersdata, setmonthWiseCustomersdata] = useState('');
    useEffect(() => {
        setChartData(dateWiseCustomers);
        setmonthWiseCustomersdata([monthWiseCustomers]);

    },[dateWiseCustomers,monthWiseCustomers]);
    ...
    const handleTimeFrameChange = (event) => {
        ...
        if (value === 'day') {
            ...
            setChartData(monthWiseCustomersdata);
        }
    };
