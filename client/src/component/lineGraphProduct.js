...
const dataDay = [
    ...
    { name: 'Day 5', sales: 890, revenue: 4800 },
...
const dataWeek = [
    ...
    { name: 'Week 2', sales: 1000, revenue: 13980 },
    { name: 'Week 3', sales: 22000, revenue: 19000 },
    { name: 'Week 4', sales: 2000, revenue: 15000 },
];
        ...
        <div className='mx-3 my-10 p-5 rounded-md bg-white flex flex-col shadow-2xl' style={{ width: '400px', height: '350px' }}>
            ...
            <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} margin={{ top: 10, right: 10, left: 10, bottom: 10 }}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="sales" stroke="#58508d" strokeWidth={2} />
                </LineChart>
            </ResponsiveContainer>
        </div>
    );
